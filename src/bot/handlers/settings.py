...
Example: /set_humidity_min 35"""
        ...
        await update.message.reply_text("❌ Unable to retrieve settings. Please try again.")
...
You'll now receive alerts when humidity falls below {value:.1f}%."""
        ...
        await update.message.reply_text("❌ Unable to update settings. Please try again.")
